...
**`/plugin install riprap@influpert`** installs the plugin: 19 guardrail documents, six
...
`/riprap:release` and `/riprap:reviewer`. There is nothing to merge, and a project with its
own `/learn` keeps it.
